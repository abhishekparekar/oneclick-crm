...
if (!isVercel) {
  ...
  const { initTrackingMidnightCron } = require("./cron/trackingCron");
  initCronJobs();
  initAttendanceCron();
  initReminderCron();
  initCron();
...
app.use((req, res, next) => {
  ...
  res.setHeader("Access-Control-Allow-Headers", "Content-Type, Authorization, X-Requested-With, X-Platform, x-platform, access-control-request-private-network");
