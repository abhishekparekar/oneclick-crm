...
import { uploadMediaFileApi, submitFollowUpApi, updateTaskChecklistApi, uploadTaskAttachmentApi } from "../../api/taskService";
...
const CompanyTaskDetailsScreen = ({ route, navigation }) => {
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      await addCompanyTaskCommentApi(taskId, commentToSend, attachmentsList);
      setNewComment("");
      setAttachedFile(null);
      fetchTask(true);
    } catch (err) {
