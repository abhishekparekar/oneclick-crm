...
const EmployeeApplyLeaveScreen = ({ navigation }) => {
  ...
  const fetchBalance = async () => {
    try {
      ...
      setBalance({ casual: 12, sick: 10, annual: 15, lop: 0 });
    } finally {
  ...
  return (
    <EmployeeLayout navigation={navigation} title="Request Time Off" backEnabled={true}>
...
export default EmployeeApplyLeaveScreen;
