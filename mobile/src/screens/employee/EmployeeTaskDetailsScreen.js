            ...
            <View style={styles.grid}>
              ...
              <View style={styles.gridItem}>
                ...
                <View style={styles.gridContent}>
                  ...
                  <Text style={styles.gridValue} numberOfLines={1}>{task.assignedBy?.name || "Manager / Admin"}</Text>
                </View>
              </View>
            ...
            <View style={styles.sectionCard}>
              <View style={styles.sectionHeaderRow}>
                ...
                <Text style={styles.sectionTitle}>
                  Task Checklist ({completedChecklistCount}/{checklistItems.length})
                </Text>
              </View>
              ...
              <View style={styles.checklistProgressTrack}>
                <View 
                  style={[
                    ...
                    { width: `${Math.round((completedChecklistCount / checklistItems.length) * 100)}%` }
                  ]} 
                />
              </View>
              ...
              {checklistItems.map((item, idx) => (
                ...
                >
                  ...
                  />
                  <Text style={[styles.checklistRowText, item.isCompleted && styles.checklistRowTextCompleted]}>
                    {item.title}
                  </Text>
