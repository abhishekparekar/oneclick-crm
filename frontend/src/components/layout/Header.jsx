...
const Header = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-14 bg-white/90 dark:bg-[#090D16]/90 backdrop-blur-md border-b border-black/[0.06] dark:border-white/[0.06] flex items-center justify-between px-3.5 sm:px-6 sticky top-0 z-40 transition-colors">
