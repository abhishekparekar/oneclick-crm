...
export default function ProjectEditModal({ isOpen, onClose, editData }) {
  ...
  const initialForm = useMemo(() => {
    if (!editData) return {
      name: "", description: "", status: "planning", priority: "medium", startDate: getTodayDateString(), endDate: "", nextFollowUpDate: "", members: [], departmentId: "", attachments: []
    };
    return {
      name: editData.name || "",
      ...
      members: editData.members?.map(m => m._id || m) || [],
  ...
  const updateMut = useMutation({
    mutationFn: (data) => updateManagerProjectApi(editData._id, data),
    onSuccess: () => {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm overflow-y-auto">
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-theme-4/20 bg-theme-4/10 dark:bg-ca-bg">
          <h2 className="text-xl font-black text-slate-800 dark:text-white">Edit Project</h2>
