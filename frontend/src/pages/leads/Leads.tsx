  ...
  return (
    <div className="animate-fadeIn space-y-2.5 max-w-[1440px] mx-auto pt-0 pb-8 font-sans text-slate-900 dark:text-slate-100">
      ...
      <div className="bg-white dark:bg-[#111C24] rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-2xs flex flex-col overflow-hidden">
        ...
        <div>
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center space-y-4 bg-white dark:bg-[#111C24] rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-2xs my-3">
              <div className="relative">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-xs text-slate-400">Please wait while we fetch contacts and lead records</p>
              </div>
            </div>
          ) : leads.length === 0 ? (
