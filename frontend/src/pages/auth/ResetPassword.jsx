...
import { Lock, Eye, EyeOff, CheckCircle, AlertCircle, ArrowLeft, KeyRound, ShieldCheck, ArrowRight } from "lucide-react";
            ...
            <div className="text-center py-4 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500 font-medium max-w-sm mx-auto leading-relaxed">
                  Your credentials have been securely updated. You can now proceed directly to your workspace or sign in again.
                </p>
              </div>
              ...
              <div className="pt-2 space-y-2.5">
                {successData?.token && (
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 py-3 px-6 rounded-xl text-xs font-black uppercase tracking-wider text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 active:from-blue-800 active:to-indigo-800 shadow-md shadow-blue-600/25 transition-all cursor-pointer"
                  >
                ...
                <Link
                  to="/login"
                  className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-6 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-all cursor-pointer"
                >
                  <ArrowLeft size={15} />
